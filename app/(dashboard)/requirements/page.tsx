    ...
    <div className="mx-auto max-w-7xl space-y-6">
      <section className="flex flex-col justify-between gap-4 rounded-lg border border-slate-200 bg-white p-5 shadow-sm sm:flex-row sm:items-center">
        <div>
          ...
          <h1 className="mt-3 text-2xl font-bold text-slate-950">Requirements</h1>
        </div>
        <Link href="/requirements/new">
          <Button className="h-10 gap-2 bg-[#2563EB] text-white hover:bg-[#1d4ed8]">
            ...
            <CardContent className="space-y-5 px-5 py-5">
              ...
              <div className="space-y-2">
                ...
                <div className="space-y-2">
                  {categoryTree.map((group) => (
                    <details key={group.name} className="rounded-lg border border-slate-200" open>
                          ...
                          <button
                            ...
                            className={cn(
                              ...
                              filters.categoryId === item.id
                                ? "bg-blue-50 font-semibold text-[#1E3A5F]"
              ...
              <div className="space-y-2">
                ...
                <select
                  ...
                  className="h-10 w-full rounded-lg border border-slate-200 bg-white px-3 text-sm outline-none focus:border-[#2563EB] focus:ring-2 focus:ring-[#2563EB]/25"
                >
              ...
              <label className="flex items-center justify-between gap-3 rounded-lg border border-slate-200 px-3 py-3 text-sm font-medium text-slate-700">
        ...
        <section className="space-y-4">
          <div className="flex flex-col justify-between gap-3 rounded-lg border border-slate-200 bg-white px-4 py-3 shadow-sm sm:flex-row sm:items-center">
            <div className="flex items-center gap-2 text-sm text-slate-600">
              ...
              Showing {visibleRequirements.length} of {filteredRequirements.length}
            </div>
            {loading ? (
          ...
          <div className="grid gap-4">
            {visibleRequirements.map((requirement) => (
              <Card key={requirement.id} className="rounded-lg border-slate-200 shadow-sm">
                <CardContent className="space-y-5 px-5 py-5">
          ...
          {!visibleRequirements.length ? (
            <div className="rounded-lg border border-dashed border-slate-300 bg-white px-6 py-12 text-center">
              ...
              <p className="mt-1 text-sm text-slate-500">Adjust filters to see more opportunities.</p>
            </div>
          ) : null}
